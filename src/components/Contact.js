  ...
  return (
    <div className="Ccontact">
      <div className="CworkTogether">
        ...
        <ParallaxLayer offset={0.9} speed={0.75} style={{ zIndex: 6 }}>
        <GetInTouch/>
        </ParallaxLayer>
      ...
      <div className="CcontactButtons">
        <div className="pointer CcontactButtonsInner CemailBtn Cfilling">
          <div>johaibansari001@gmail.com</div>
        </div>
        <div className="pointer CcontactButtonsInner CnumberBtn Cfilling">
          <div>+91 8 05 75 15 621</div>
        </div>
      </div>
